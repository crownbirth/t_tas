  ...
  if(is_uploaded_file($_FILES['filename']['tmp_name'])){
	...
	$insert_query = sprintf("INSERT INTO student (stdid, fname, lname, mname, progid, phone, email, addr, sex, dob, "
                ...
                . "VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString(md5($data[2]), "text"),
                       GetSQLValueString($data[13], "text"),
                       GetSQLValueString($data[14], "int"),
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO student (stdid, fname, lname, mname, progid, phone, email, addr, sex, dob, sesid, `level`, `stid`, admode, password, status, `access`, credit, profile) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<?php include 'include/topmenu.php'; ?>
  ...
  <div class="pagetitle">
    <table width="600">
      <tr>
        <td><!-- InstanceBeginEditable name="pagetitle" --> Add New Student<!-- InstanceEndEditable --></td>
      </tr>
    </table>
  </div>
<div class="sidebar1">
...
?>
      ...
      <tr>
          <td align="left">Choose College<br/>
...
?>
          ...
          <td align="left" >View By Programme<br/>
...
?>
          ...
          <td width="101" align="left">Choose Level<br/>
      ...
      <tr>
        <td colspan="4" width="700"  colspan="5">
        	<table width="650" border="0">
                    ...
                    <?php do { ?>
                        <tr>
                            ...
                            <td colspan="2"><?php echo $row_student['fname']; ?>, <?php echo ucwords(strtolower($row_student['lname'])); ?></td>
                            <td><a href="editstdnt.php?stid=<?php echo $row_student['stdid']; ?>">Edit</a></td>
                        </tr>
