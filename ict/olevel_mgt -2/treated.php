...
<?php include '../include/topmenu.php'; ?>
  ...
  <div class="pagetitle">
    <table width="600">
      <tr>
        <td><!-- InstanceBeginEditable name="pagetitle" --> Prospective Students O'Level Verification Report Page  <!-- InstanceEndEditable --></td>
      </tr>
    </table>
  </div>
<div class="sidebar1">
                    ...
                    <table width="690" class="table table-bordered table-condensed table-striped table-hover">
                      <thead>
                          <tr>
                              ...
                              <th ng-show="active" width="70">Re-Process</th>
                          </tr>
                      </thead>
                      <tbody >
