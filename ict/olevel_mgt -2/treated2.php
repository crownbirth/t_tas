...
<?php include '../include/topmenu.php'; ?>
  ...
  <div class="pagetitle">
    <table width="600">
      <tr>
        <td><!-- InstanceBeginEditable name="pagetitle" --> Returning Students O'Level Verification Report Page  <!-- InstanceEndEditable --></td>
      </tr>
    </table>
  </div>
<div class="sidebar1">
                        ...
                        <tr>
                            <td>
                                <table width="345" class="table table-bordered table-condensed table-striped table-hover">
                                    ...
                                    <tbody>
                                    <form method="POST" action="printreport.php" target="_blank" name="form1">
                                            <tr>
                                                <td>Programme </td>
                                                <td>
                            ...
                            <td>
                                <form method="POST" action="printreport2b.php" target="_blank" name="form2">
                                    <table  width="345" class="table table-bordered table-condensed table-striped table-hover">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><input type="hidden" name="MM_Search" value="form2"></td>
