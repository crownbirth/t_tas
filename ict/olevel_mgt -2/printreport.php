...
//if($totalRows_history > 0) {
    $html = '  <p style="text-align:center; font-size: 15pt; margin-bottom: 10px"><strong>O`LEVEL VERIFICATION REPORT</strong> ('.$_POST['level'].')</p>
                <p style="text-align:center; font-size: 15pt; margin-bottom: 10px"> '.$row_session['sesname'].' - '.$row_prog['progname'].'</p>';
    $html .='<p>&nbsp;</p>
        <div style="text-align:center; width:120%; font-size: 20pt">
