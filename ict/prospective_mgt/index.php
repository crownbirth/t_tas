...
$query_schfee = "SELECT progofferd, status, count(pstdid) as count "
                    . "FROM prospective p "
...
for($idx = 0; $idx < $totalRows_schfee; $idx++, $row_schfee = mysql_fetch_assoc($schfee)) {
   if(isset($school_fees[$row_schfee['progofferd']])) {
        $school_fees[$row_schfee['progofferd']] = $row_schfee['count'];
    }
}
