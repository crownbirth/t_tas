...
if(!checkFees($row_sess['sesid'], getSessionValue('stid'))) {
    header('Location: fees_payment/index.php');
}
...
$query_sess = sprintf("SELECT * FROM `session` %s ORDER BY sesname DESC LIMIT 1", 
...
$query_info = sprintf("SELECT s.stdid, s.jambregid, s.lname, s.fname, s.sex, l.title, l.fname as lfname, l.lname as llname, "
...
$image = array("../images/student/{$colname_stud}.jpg", "../images/student/{$pictureId}.jpg", 
                "../images/student/".strtolower($pictureId).".jpg", "../images/student/{$colname_stud}.JPG",
                "../images/student/{$pictureId}.JPG", "../images/student/".strtolower($pictureId).".JPG", 
                "../images/student/{$colname_stud}.png", "../images/student/{$pictureId}.png", 
                "../images/student/".strtolower($pictureId).".png", "../images/student/{$colname_stud}.PNG", 
                "../images/student/{$pictureId}.PNG", "../images/student/".strtolower($pictureId).".PNG", 
                "../images/student/{$colname_stud}.gif", "../images/student/{$pictureId}.gif", 
                "../images/student/".strtolower($pictureId).".gif", "../images/student/{$colname_stud}.GIF", 
...
$query_reg = sprintf("SELECT * FROM registration r WHERE stdid = %s", GetSQLValueString($colname_stud, "text"));
...
if($row_reg['course'] == 'Registered') {
        $query_course = sprintf("SELECT DISTINCT r.csid, c.semester, c.csname, c.status, unit "
