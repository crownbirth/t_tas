...
//		$result = mysql_query($sqlget);
                        ...
                        $query_paid= sprintf("UPDATE prospective SET formpayment=%s WHERE jambregid=%s", GetSQLValueString("Yes", "text"), GetSQLValueString(getSessionValue('MM_Username'), "text"));
                        $paid= mysql_query($query_paid, $tams);
