...
//		$result = mysql_query($sqlget);
                ...
                $update= sprintf("UPDATE  appfee_transactions SET amt='0',resp_code='".$rc."',resp_desc = '".$res."', auth_code='".$ac."', pan='".$pan."', status = 'DECLINED', name='".$name."', date_time='".$dt."', xml = '".$xmlmsg."' WHERE  ordid='".$ordid."'");
