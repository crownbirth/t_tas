...
$MM_authorizedUsers = "11,20,21,22,23,24";
...
$jambregid = getSessionValue('MM_Username');

if(isset($_GET['stid']) && in_array(getIctAccess(), array(20, 24))) {
    $jambregid = $_GET['stid'];
}
...
if($row_rschk['formsubmit'] == 'No' && !in_array(getIctAccess(), array(20, 24))) {
...
$imgnameUpper = $jambregid;
$imgnameLower = strtolower($jambregid);
                    ...
                    <td colspan="1">
                        <table width="320" class="table table-hover table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td align="left"><?php echo $row_rspros['jambscore1']?></td>
                            </tr>
                            <tr>
