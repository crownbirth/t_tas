                ...
                <form name="form1" method="post" action="<?php echo $editFormAction?>">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="jambregid" maxlength="12"/></td>
                        </tr>
                        <tr>
                            <th>Surname</th>
                            <td><input type="text" name="surnname" maxlength="15"/></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                    ...
                    <thead>
                        <tr>
                            <td colspan="2" align="center">
                                <h3>Applicant Seeking Change of Institution</h3>
                                <p align="justify">
