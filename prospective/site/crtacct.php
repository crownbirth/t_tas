...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1") && $_POST['fname'] != null && $_POST['lname']!= null && $_POST['email'] !=null && $_POST['jambregid']!= NULL ) {
    ...
    if($num_row_chk <= 0){  
        $insertSQL = sprintf("INSERT INTO prospective (jambregid, regtype, jambyear, admtype, fname, mname, Sex, lname, email, phone, sesid, access)"
                                                  . " VALUES (%s,%s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s)",
                                                  GetSQLValueString($_POST['jambregid'], "text"),
                                                  GetSQLValueString($_POST['regtype'], "text"),
                                                  GetSQLValueString($_POST['jambyear'], "text"),
                                                  GetSQLValueString($_POST['admtype'], "text"),
        ...
        $error_msg = "You can Not Re-register with this UTME Reg. No. it already Exist on the server ";
...
<?php include '../include/topmenu.php'; ?>
  ...
  <div class="pagetitle">
    <table width="600">
      <tr>
        <td><!-- InstanceBeginEditable name="pagetitle" --><?php echo "{$adm_ses_name} Post UTME / DE Application "?><!-- InstanceEndEditable --></td>
      </tr>
    </table>
  </div>
<div class="sidebar1">
                      ...
                      <table width="690" class="table  table-striped table-condensed">
                            ...
                            <tr>
                                ...
                                <td align="left" colspan="3">
                                    ...
                                    <span style="color: #FF1188">* specify if D.E or UTME </span>
                                </td>  
                            </tr>
                            <tr>
                                <td colspan="4">&nbsp;</td>  
                        ...
                        <input type="hidden" name="regtype" value="coi" />
