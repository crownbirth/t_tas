...
<ul class="sidemenu">
  ...
  <li><a href="<?php echo $link."/";?>payment/paylist.php" class="sidemenu">Payment List</a></li>
  <li><a href="<?php echo $link."/";?>registration/viewform.php" class="sidemenu">Registration Form</a></li>
  <li><a href="<?php echo $link."/";?>result/uploadresult.php" class="sidemenu">Upload Result</a></li>
  <li><a href="<?php echo $link."/";?>result/" class="sidemenu">Consider Result</a></li>
  <li><a href="<?php echo $link."/";?>result/transcript.php" class="sidemenu">Statement of Result</a></li>
...
<ul class="sidemenu">
  ...
  <li><a href="<?php echo $link."/";?>student/fees_payment/index.php" class="sidemenu">Pay School Fees</a></li>
  <li><a href="<?php echo $link."/";?>student/fees_payment/payhistory.php" class="sidemenu">Payment History</a></li>
  
  <?php if($_SESSION['level'] == '5'){?>
  <li><a href="<?php echo $link."/";?>student/pay_verify.php" class="sidemenu" target="_new">Print Clearrance</a></li>
  <li><a href="<?php echo $link."/";?>olevel_verification/index.php" class="sidemenu">O'Level Verification</a></li>
  <?php }?>
</ul>
