...
<?php include '../include/topmenu.php'; ?>
  ...
  <div class="pagetitle">
    <table width="600">
      <tr>
        <td><!-- InstanceBeginEditable name="pagetitle" -->Summary Sheet <!-- InstanceEndEditable --></td>
      </tr>
    </table>
  </div>
<div class="sidebar1">
  ...
  <div class="content"><!-- InstanceBeginEditable name="maincontent" -->
      <form name="broadsheet" method="post" target='_blank' action="smprint.php">
    <table width="690">
    ...
    <tr><td width="146" height="59"><table width="625" border="0" align="center">
      <tr>
        ...
        <td width="207" align="center"><input type="submit" name="submit" id="submit" value="Process Summary Sheet" /></td>
        </tr>
    </table></td></tr>
